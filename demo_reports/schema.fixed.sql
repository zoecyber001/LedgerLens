...
CREATE TABLE wallet_ledger (id SERIAL PRIMARY KEY,    
  ...
  DECIMAL(15,2), balance DECIMAL(15,2),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_wallet_ledger_balance CHECK (debit >= 0 AND credit >= 0)
); CREATE TABLE customer_identities (id SERIAL PRIMARY KEY, bvn_encrypted BYTEA,  
  nin_encrypted BYTEA, card_pan VARCHAR(16)
);
